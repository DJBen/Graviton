...
//                        let cgImage = blurredImage.cgImage?.cropping(to: CGRect(x: 0, y: tabBar.frame.origin.y * scale, width: tabBar.frame.width * scale, height: tabBar.frame.height * scale))
//                        let newImage = UIImage(cgImage: cgImage!, scale: scale, orientation: blurredImage.imageOrientation)
//                        tabBar.backgroundImage = newImage
//                    }
//                }
            }
        }
