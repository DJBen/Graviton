...
class OrbitLineNode: LineNode {
    init(celestialBody: CelestialBody, origin: CelestialBody, ephemeris: Ephemeris, color: UIColor, numberOfVertices: Int = 200, rawToModelCoordinateTransform: (Vector3) -> Vector3 = { $0 }) {
