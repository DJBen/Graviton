...
class MotionParserTest: XCTestCase {
    ...
    func testParsingMars() {
        ...
        XCTAssertEqual(body!.obliquity.wrappedValue, 25.19, accuracy: 1e-3)
    ...
    func testParsingEarth() {
        ...
        XCTAssertEqual(body!.obliquity.wrappedValue, 23.45, accuracy: 1e-3)
    ...
    func testParsingVenus() {
        ...
        XCTAssertEqual(body!.obliquity.wrappedValue, 177.3, accuracy: 1e-3)
    ...
    func testParsingNeptune() {
        ...
        XCTAssertEqual(body!.obliquity.wrappedValue, 29.56, accuracy: 1e-3)
    ...
    func testParsingPluto() {
        ...
        XCTAssertEqual(body!.obliquity.wrappedValue, 0, accuracy: 1e-3)
    ...
    func testParsingMoon() {
        ...
        XCTAssertEqual(body!.obliquity.wrappedValue, 6.67, accuracy: 1e-4)
