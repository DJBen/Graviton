...
class OrbitalMotionTest: XCTestCase {
    func testCopying() {
        let motion = OrbitalMotionMoment(orbit: Orbit(semimajorAxis: 123, eccentricity: 0.2, inclination: 0.5, longitudeOfAscendingNode: 0.7, argumentOfPeriapsis: 1.2), gm: 1234, julianDate: 0.0, timeOfPeriapsisPassage: 0.0)
